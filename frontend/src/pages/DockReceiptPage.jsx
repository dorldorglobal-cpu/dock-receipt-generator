...
return (
  ...
  {scheduleInfo?.saved ? (
    <>
      ...
      <br />
      <strong>Rows:</strong> {scheduleInfo.rows}
      <br />
      <strong>Updated:</strong>{" "}
      {new Date(scheduleInfo.updatedAt).toLocaleString()}
    </>
  ) : (
...
export default DockReceiptPage;